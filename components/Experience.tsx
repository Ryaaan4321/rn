                            ...
                            <div className="pl-6 sm:pl-12">
                                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-4 sm:mb-6">
                                    <div className="flex flex-col sm:flex-row sm:gap-3">
                                        <p className="text-xl sm:text-4xl font-semibold text-black dark:text-stone-300">
                                            {exp.title}
                                        </p>
                                        <p className="text-lg sm:text-3xl text-gray-600 font-light dark:text-stone-300">
                                            {exp.company}
                                        </p>
                                    </div>
                                ...
                                <p className="text-sm sm:text-base text-gray-700 font-light mb-4 sm:mb-6 dark:text-stone-300">
                                    {exp.description}
                                </p>
